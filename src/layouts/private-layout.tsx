...
export const PrivateLayout = () => {
  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="gro-ui-theme">
      <main className="flex flex-col-reverse lg:flex-row  items-center lg:gap-4 w-full h-screen px-4 bg-neutral-900">
        <Sidebar />

        <div className="flex  items-center w-full   gap-2 h-11/12">
          <Outlet />
        </div>
      </main>
    </ThemeProvider>
